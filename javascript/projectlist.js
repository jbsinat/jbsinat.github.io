...
//http://127.0.0.1:8089/project/get/projects
...
// Get('/weixin_project/api/user/getAllBnsCategory',function(res) {
    ...
    Get('/project/get/projects', function(res) {
        const data = res.extend
        ...
        for(var i=0;i<businesses.length;i++) {
            ...
            strdis = '<p style="top: 0.06rem; right: 0.2rem; color:#ff824d;"><span style="font-size: 0.24rem;">' + businesses[i].category + '</span></p>';
            strname = '<h3 class="shopname">' + businesses[i].proTitle + '</h3>' + '<p style="left: 1.12rem;" class="shopaddress">地址：' + businesses[i].proAddress + '</p>';
